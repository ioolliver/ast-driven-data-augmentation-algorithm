...
SCORES_OUTPUT_PATH = RESULTS_DIR / "geo_dataset_component_matching_scores.json"
REPORT_OUTPUT_PATH = RESULTS_DIR / "geo_dataset_component_matching_report.md"
...
def write_report(output_path, metadata, summary, scored_rows):
    ...
    if suffix == ".md":
        ...
        return
    if suffix == ".xlsx":
        from .workbook import write_component_matching_workbook
