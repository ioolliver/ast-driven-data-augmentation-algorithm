...
from .dataset import load_augmented_rows

RESULTS_DIR = REPO_ROOT / "results" / "atlas_sql_br"
INPUT_DATASET_PATH = RESULTS_DIR / "geo_dataset_augmented_only.json"
SCORES_OUTPUT_PATH = RESULTS_DIR / "geo_dataset_semantic_variation_scores.json"
REPORT_OUTPUT_PATH = RESULTS_DIR / "geo_dataset_semantic_variation_report.md"
...
def write_report(output_path, metadata, summary, scored_rows):
    ...
    if suffix == ".md":
        ...
        return
    if suffix == ".xlsx":
        from .workbook import write_semantic_variation_workbook

        write_semantic_variation_workbook(
